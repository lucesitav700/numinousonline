...
class Enqueue
{
    ...
    public function admin_scripts( $hook = '', $should_check = true )
    {
        ...
        wp_register_script(
            'igd-react-sortable-hoc',
            IGD_ASSETS . '/vendor/react-sortable-hoc.js',
            [],
            IGD_VERSION,
            true
        );
        ...
        //		wp_register_script( 'igd-react-photo-gallery', IGD_ASSETS . '/vendor/react-photo-gallery.js', [ 'igd-admin' ], IGD_VERSION, true );
        //
        //		if ( ( ! empty( $admin_pages['shortcode_builder_page'] ) && $admin_pages['shortcode_builder_page'] === $hook ) || $this->is_block_editor() || $this->is_divi_builder() ) {
        //			wp_enqueue_script( 'igd-react-photo-gallery' );
        //		}
