...
class Hooks
{
    ...
    public function render_form_field_data( $data, $as_html )
    {
        ...
        $folder_location = sprintf( '<a target="_blank" style="text-decoration: none; font-weight: bold; color: #1a7efb" href="https://drive.google.com/drive/folders/%1$s"><strong>%2$s</strong></a>', $parent_id, __( 'Google Drive', 'integrate-google-drive' ) );
