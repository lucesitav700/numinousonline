...
class Download {
	...
	public function export_content() {
		...
		if ( ( $this->file['size'] <= 10485760 ) && ( empty( $export_link ) || ! Permissions::instance( $this->account_id )->has_permission( $this->file ) || 'proxy' == $this->download_method ) ) {
	...
	public function set_download_method() {
		...
		// Files larger than 100MB can only be streamed unfortunately
